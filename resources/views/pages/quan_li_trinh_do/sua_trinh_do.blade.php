@extends('layouts.app', ['activePage' => 'quan_li_trinh_do', 'titlePage' => __('Sửa trình độ')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('update_trinh_do', ['id' => $trinh_do->ma_td]) }}"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('ten_td') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('ten_td') ? ' is-invalid' : '' }}"
                                                name="ten_td" value="{{ $trinh_do->ten_td }}" id="input-ten_td"
                                                type="text" placeholder="{{ __('Sửa tên trình độ') }}" />
