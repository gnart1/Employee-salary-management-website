@extends('layouts.app', ['activePage' => 'quan_li_loai_bh', 'titlePage' => __('Sửa loại bảo hiểm')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('update_loai_bh', ['id' => $loai_bh->ma_loai_bh]) }}"
                        autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('post')
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Sửa loại bảo hiểm') }}</h4>
                            </div>
                            <div class="card-body ">
                                @if (session('status'))
                                    <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('ten_loai_bh') ? ' has-danger' : '' }}">
                                            <input
                                                ...
                                                name="ten_loai_bh" value="{{ $loai_bh->ten_loai_bh }}" type="text"
                                                placeholder="{{ __('Sửa tên loại bảo hiểm') }}" />
